...
goog.exportSymbol('proto.couchbase.view.v1.ViewQueryRequest.Namespace', null, global);
...
proto.couchbase.view.v1.ViewQueryRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 18:
      ...
      break;
    case 19:
      var value = /** @type {!proto.couchbase.view.v1.ViewQueryRequest.Namespace} */ (reader.readEnum());
...
proto.couchbase.view.v1.ViewQueryRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = /** @type {!proto.couchbase.view.v1.ViewQueryRequest.Namespace} */ (jspb.Message.getField(message, 19));
  if (f != null) {
    writer.writeEnum(
      19,
      f
 ...
 * @enum {number}
 */
proto.couchbase.view.v1.ViewQueryRequest.Namespace = {
 ...
 * @return {!proto.couchbase.view.v1.ViewQueryRequest.Namespace}
 */
proto.couchbase.view.v1.ViewQueryRequest.prototype.getNamespace = function() {
  return /** @type {!proto.couchbase.view.v1.ViewQueryRequest.Namespace} */ (jspb.Message.getFieldWithDefault(this, 19, 0));
};


/**
 * @param {!proto.couchbase.view.v1.ViewQueryRequest.Namespace} value
 * @return {!proto.couchbase.view.v1.ViewQueryRequest} returns this
 */
