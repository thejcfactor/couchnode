...
var couchbase_internal_hooks_v1_hooks_pb = require('../../../../couchbase/internal/hooks/v1/hooks_pb.js');
var google_protobuf_any_pb = require('google-protobuf/google/protobuf/any_pb.js');

function serialize_couchbase_internal_hooks_v1_AddHooksRequest(arg) {
  if (!(arg instanceof couchbase_internal_hooks_v1_hooks_pb.AddHooksRequest)) {
...
function deserialize_couchbase_internal_hooks_v1_AddHooksRequest(buffer_arg) {
  return couchbase_internal_hooks_v1_hooks_pb.AddHooksRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_couchbase_internal_hooks_v1_AddHooksResponse(arg) {
  if (!(arg instanceof couchbase_internal_hooks_v1_hooks_pb.AddHooksResponse)) {
...
function deserialize_couchbase_internal_hooks_v1_AddHooksResponse(buffer_arg) {
  return couchbase_internal_hooks_v1_hooks_pb.AddHooksResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_couchbase_internal_hooks_v1_CreateHooksContextRequest(arg) {
  if (!(arg instanceof couchbase_internal_hooks_v1_hooks_pb.CreateHooksContextRequest)) {
...
function deserialize_couchbase_internal_hooks_v1_CreateHooksContextRequest(buffer_arg) {
  return couchbase_internal_hooks_v1_hooks_pb.CreateHooksContextRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_couchbase_internal_hooks_v1_CreateHooksContextResponse(arg) {
  if (!(arg instanceof couchbase_internal_hooks_v1_hooks_pb.CreateHooksContextResponse)) {
...
function deserialize_couchbase_internal_hooks_v1_CreateHooksContextResponse(buffer_arg) {
  return couchbase_internal_hooks_v1_hooks_pb.CreateHooksContextResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_couchbase_internal_hooks_v1_DestroyHooksContextRequest(arg) {
  if (!(arg instanceof couchbase_internal_hooks_v1_hooks_pb.DestroyHooksContextRequest)) {
...
function deserialize_couchbase_internal_hooks_v1_DestroyHooksContextRequest(buffer_arg) {
  return couchbase_internal_hooks_v1_hooks_pb.DestroyHooksContextRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_couchbase_internal_hooks_v1_DestroyHooksContextResponse(arg) {
  if (!(arg instanceof couchbase_internal_hooks_v1_hooks_pb.DestroyHooksContextResponse)) {
...
function deserialize_couchbase_internal_hooks_v1_DestroyHooksContextResponse(buffer_arg) {
  return couchbase_internal_hooks_v1_hooks_pb.DestroyHooksContextResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_couchbase_internal_hooks_v1_SignalBarrierRequest(arg) {
  if (!(arg instanceof couchbase_internal_hooks_v1_hooks_pb.SignalBarrierRequest)) {
...
function deserialize_couchbase_internal_hooks_v1_SignalBarrierRequest(buffer_arg) {
  return couchbase_internal_hooks_v1_hooks_pb.SignalBarrierRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_couchbase_internal_hooks_v1_SignalBarrierResponse(arg) {
  if (!(arg instanceof couchbase_internal_hooks_v1_hooks_pb.SignalBarrierResponse)) {
...
function deserialize_couchbase_internal_hooks_v1_SignalBarrierResponse(buffer_arg) {
  return couchbase_internal_hooks_v1_hooks_pb.SignalBarrierResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_couchbase_internal_hooks_v1_WatchBarrierRequest(arg) {
  if (!(arg instanceof couchbase_internal_hooks_v1_hooks_pb.WatchBarrierRequest)) {
...
function deserialize_couchbase_internal_hooks_v1_WatchBarrierRequest(buffer_arg) {
  return couchbase_internal_hooks_v1_hooks_pb.WatchBarrierRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_couchbase_internal_hooks_v1_WatchBarrierResponse(arg) {
  if (!(arg instanceof couchbase_internal_hooks_v1_hooks_pb.WatchBarrierResponse)) {
...
function deserialize_couchbase_internal_hooks_v1_WatchBarrierResponse(buffer_arg) {
  return couchbase_internal_hooks_v1_hooks_pb.WatchBarrierResponse.deserializeBinary(new Uint8Array(buffer_arg));
}


var HooksServiceService = exports.HooksServiceService = {
  createHooksContext: {
    path: '/couchbase.internal.hooks.v1.HooksService/CreateHooksContext',
    requestStream: false,
    responseStream: false,
    requestType: couchbase_internal_hooks_v1_hooks_pb.CreateHooksContextRequest,
    responseType: couchbase_internal_hooks_v1_hooks_pb.CreateHooksContextResponse,
  ...
  destroyHooksContext: {
    path: '/couchbase.internal.hooks.v1.HooksService/DestroyHooksContext',
    requestStream: false,
    responseStream: false,
    requestType: couchbase_internal_hooks_v1_hooks_pb.DestroyHooksContextRequest,
    responseType: couchbase_internal_hooks_v1_hooks_pb.DestroyHooksContextResponse,
  ...
  addHooks: {
    path: '/couchbase.internal.hooks.v1.HooksService/AddHooks',
    requestStream: false,
    responseStream: false,
    requestType: couchbase_internal_hooks_v1_hooks_pb.AddHooksRequest,
    responseType: couchbase_internal_hooks_v1_hooks_pb.AddHooksResponse,
  ...
  watchBarrier: {
    path: '/couchbase.internal.hooks.v1.HooksService/WatchBarrier',
    requestStream: false,
    responseStream: true,
    requestType: couchbase_internal_hooks_v1_hooks_pb.WatchBarrierRequest,
    responseType: couchbase_internal_hooks_v1_hooks_pb.WatchBarrierResponse,
  ...
  signalBarrier: {
    path: '/couchbase.internal.hooks.v1.HooksService/SignalBarrier',
    requestStream: false,
    responseStream: false,
    requestType: couchbase_internal_hooks_v1_hooks_pb.SignalBarrierRequest,
    responseType: couchbase_internal_hooks_v1_hooks_pb.SignalBarrierResponse,
...
exports.HooksServiceClient = grpc.makeGenericClientConstructor(HooksServiceService);
