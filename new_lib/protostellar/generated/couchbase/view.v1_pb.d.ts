...
export class ViewQueryRequest extends jspb.Message {
  ...
  clearNamespace(): void;
  getNamespace(): ViewQueryRequest.DesignDocumentNamespaceMap[keyof ViewQueryRequest.DesignDocumentNamespaceMap];
  setNamespace(value: ViewQueryRequest.DesignDocumentNamespaceMap[keyof ViewQueryRequest.DesignDocumentNamespaceMap]): void;
...
export namespace ViewQueryRequest {
  export type AsObject = {
    ...
    debug: boolean,
    namespace: ViewQueryRequest.DesignDocumentNamespaceMap[keyof ViewQueryRequest.DesignDocumentNamespaceMap],
  ...
  export interface DesignDocumentNamespaceMap {
    PRODUCTION: 0;
    DEVELOPMENT: 1;
  }

  export const DesignDocumentNamespace: DesignDocumentNamespaceMap;
