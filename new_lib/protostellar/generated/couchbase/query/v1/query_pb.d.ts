...
export class QueryRequest extends jspb.Message {
  ...
  getScanConsistency(): QueryRequest.ScanConsistencyMap[keyof QueryRequest.ScanConsistencyMap];
  setScanConsistency(value: QueryRequest.ScanConsistencyMap[keyof QueryRequest.ScanConsistencyMap]): void;
  ...
  getConsistentWithList(): Array<couchbase_kv_v1_kv_pb.MutationToken>;
  setConsistentWithList(value: Array<couchbase_kv_v1_kv_pb.MutationToken>): void;
  addConsistentWith(value?: couchbase_kv_v1_kv_pb.MutationToken, index?: number): couchbase_kv_v1_kv_pb.MutationToken;

  hasProfileMode(): boolean;
  clearProfileMode(): void;
  getProfileMode(): QueryRequest.ProfileModeMap[keyof QueryRequest.ProfileModeMap];
  setProfileMode(value: QueryRequest.ProfileModeMap[keyof QueryRequest.ProfileModeMap]): void;
...
export namespace QueryRequest {
  export type AsObject = {
    ...
    scanConsistency: QueryRequest.ScanConsistencyMap[keyof QueryRequest.ScanConsistencyMap],
    positionalParametersList: Array<Uint8Array | string>,
    namedParametersMap: Array<[string, Uint8Array | string]>,
    flexIndex: boolean,
    preserveExpiry: boolean,
    consistentWithList: Array<couchbase_kv_v1_kv_pb.MutationToken.AsObject>,
    profileMode: QueryRequest.ProfileModeMap[keyof QueryRequest.ProfileModeMap],
  }
  ...
  export interface ProfileModeMap {
    PROFILE_MODE_OFF: 0;
    PROFILE_MODE_PHASES: 1;
    PROFILE_MODE_TIMINGS: 2;
  }

  export const ProfileMode: ProfileModeMap;
}
...
export namespace QueryResponse {
  ...
  export class MetaData extends jspb.Message {
    ...
    getStatus(): QueryResponse.MetaData.StatusMap[keyof QueryResponse.MetaData.StatusMap];
    setStatus(value: QueryResponse.MetaData.StatusMap[keyof QueryResponse.MetaData.StatusMap]): void;
  ...
  export namespace MetaData {
    export type AsObject = {
      ...
      status: QueryResponse.MetaData.StatusMap[keyof QueryResponse.MetaData.StatusMap],
